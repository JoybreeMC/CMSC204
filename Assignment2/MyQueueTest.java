...
public class MyQueueTest {
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, stringQ.enqueue("happy"));
			assertEquals(true, stringQ.enqueue("Birthday"));
			assertEquals(5, stringQ.size());
			//Queue is full, next statement should cause QueueOverFlowException
			stringQ.enqueue(f);
			assertTrue(false);
	...
	public void testToStringStudent() throws QueueOverflowException, QueueUnderflowException {
		assertEquals("abc", stringQ.toString());
		stringQ.enqueue("Hi");
		assertEquals("abcHi", stringQ.toString());
		stringQ.enqueue("apple");
		assertEquals("abcHiapple", stringQ.toString());
		stringQ.dequeue();
		System.out.print(stringQ.toString());
		assertEquals("bcHiapple", stringQ.toString());
		stringQ.enqueue("E");
		assertEquals("bcHiappleE", stringQ.toString());
	}
